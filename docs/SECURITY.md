...
Administrator profile support is planned, but version `0.0.4` does not silently elevate or reuse elevated tokens.

## Plugin Runtime

Plugin manifest/catalog validation exists as scaffolding. Plugin execution is not enabled in version `0.0.4`.
