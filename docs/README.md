...
`0.0.4` is a working MVP foundation. It includes real shell hosting, a Windows Terminal-backed terminal surface, profile detection, tabs, panes, settings, snippets, command discovery, safety prompts, ZIP packaging, MSI packaging, and tests.
